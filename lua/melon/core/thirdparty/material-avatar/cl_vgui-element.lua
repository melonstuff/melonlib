...
local getAvatarMaterial = melon.thirdparty.getAvatarMaterial

local PANEL = {}

function PANEL:Init()
	getAvatarMaterial = melon.thirdparty.getAvatarMaterial
...
vgui.Register("Melon:AvatarMaterial", PANEL, "Panel")